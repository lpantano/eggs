...
The idea of this report is to show how well aligners are decting
...
I simulated a bunch of isomirs (~16900) that can have the folowing variation:
...
The simulation was done with the small script inside SeqBuster tool: XXXXX.
I used human miRBase to simulate isomiRs from precursors. I allowed trimming
events at both side up to 3 nucleotides, one nucleotide mutation and 
up to 3 nucleotide as addition.
...
check parameteres and tools, but if you have these tools installed, it
...
chec out: XXXXXXX. Both reports use the same simulated isomiRs file.
